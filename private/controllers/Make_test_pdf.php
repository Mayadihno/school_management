...
?>
        ...
        <?php if ($row && $answered_test_row && $answered_test_row->submitted): show($answered_test_row) ?>
            ...
            <div style="font-family: roboto;font-size: 18px;max-width: 1000px;margin: auto;">
                ...
                <?php $percentage = get_answer_percentage($answered_test_row->test_id, $user_id) ?>
                <?php $marked_percentage = get_mark_percentage($answered_test_row->test_id, $user_id) ?>
                ...
                <?php if ($marked): ?>
                    <center>
                        <?php $score_percentage = get_score_percentage($answered_test_row->test_id, $user_id) ?>
                        <small style="font-size:20px">Test Score:<br></small>
                        <div style="font-size: 60px;margin-top: -10px;"><?= $score_percentage ?>%</div>
                    </center>
                <?php endif; ?>
