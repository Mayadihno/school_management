...
<form method="post" enctype="multipart/form-data">
    <div class="mb-3">
        ...
        <div class="input-group mb-3 pt-3">
            ...
            <input type="text" class="form-control" name="comment" placeholder="Comment" id="inputGroupFile01">
        </div>
    ...
    <?php if (isset($_GET['type']) && $_GET['type'] == 'objective'): ?>
        <div class="input-group mb-3 pt-3">
            ...
            <input type="text" name="correct_answer" class="form-control" id="inputGroupFile01" placeholder="Enter Answer">
        </div>
    <?php endif; ?>
